...
export default class ViewPager extends Component {
    ...
    constructor(props) {
        ...
        this._initialPage = Math.min(Math.max(0, this.props.initialPage), Math.max(0, childrenCount - 1));
    }
    render() {
    ...
    _renderOnIOS() {
        // let childrenCount = this.props.children ? this.props.children.length : 0;
        // let initialPage = Math.min(Math.max(0, this.props.initialPage), Math.max(0, childrenCount - 1));
        ...
        let props = {
            ...
            contentOffset: {x: this.state.width * this._initialPage, y: 0},
